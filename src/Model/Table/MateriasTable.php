...
class MateriasTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('MateriaID');
        $this->setPrimaryKey('MateriaID');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('MateriaID')
            ->allowEmptyString('MateriaID', null, 'create');
        ...
        $validator
            ->integer('EXPMateria')
            ->requirePresence('EXPMateria', 'create')
            ->notEmptyString('EXPMateria');
