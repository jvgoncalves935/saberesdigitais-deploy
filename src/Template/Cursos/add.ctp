...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Listar Cursos'), ['action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('Listar Materias'), ['controller' => 'Materias', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('Adicionar Materia'), ['controller' => 'Materias', 'action' => 'add']) ?></li>
    </ul>
</nav>
